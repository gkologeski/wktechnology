...
-- 1) Fix branding policy: use workspace-members admin check (v2) instead of legacy owner-id function
DROP POLICY IF EXISTS "branding workspace admin write" ON public.workspace_branding;
...
-- 2) Add SET search_path to the four pgmq wrapper functions
...
-- 3) Harden EXECUTE on sensitive helpers: revoke from anon
