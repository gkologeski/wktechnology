...
DECLARE v_ws uuid := '184b9435-0a9b-4334-9e89-8854dc883f5d'; t text;
  v_tables text[] := ARRAY['credit_ledger','credit_limits','custom_object_records','custom_objects','custom_properties','custom_reports','dashboard_widgets','dashboards','deal_line_items','deals'];
BEGIN
