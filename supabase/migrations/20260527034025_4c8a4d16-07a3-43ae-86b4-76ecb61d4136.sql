...
DECLARE v_ws uuid := '184b9435-0a9b-4334-9e89-8854dc883f5d'; t text;
  v_tables text[] := ARRAY['tickets','webhook_deliveries','whatsapp_campaign_recipients','whatsapp_campaigns','whatsapp_conversations','whatsapp_messages','workflow_events','workflow_runs','workflows','workspace_branding'];
BEGIN
