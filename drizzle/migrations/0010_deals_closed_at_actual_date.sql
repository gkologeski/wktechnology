-- Corrige: ao mudar a etapa dentro do TechERP, usar a data real (now()).
-- A data do HubSpot (closedate) é a data prevista para negócios abertos,
-- então só serve na criação (importação de negócios já fechados no HubSpot).
