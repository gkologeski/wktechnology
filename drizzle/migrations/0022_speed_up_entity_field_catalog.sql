...
BEGIN
  ...
  LOOP
    ...
    -- uuid ficou de fora (referências usam seletor com busca); amostra limitada
    -- a 2.000 linhas para não varrer tabelas grandes coluna por coluna.
    ...
    THEN
      BEGIN
        EXECUTE format(
          ...
          r.column_name, p_table, r.column_name
