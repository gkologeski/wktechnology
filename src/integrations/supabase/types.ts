...
export type Database = {
  ...
  public: {
    ...
    Views: {
      ...
      people_total_cost: {
        Row: {
          ...
          employment_type: Database["public"]["Enums"]["people_employment_type"] | null;
          full_name: string | null;
          monthly_cost: number | null;
          owner_id: string | null;
          person_id: string | null;
    ...
    Enums: {
      ...
      email_broadcast_recipient_status: "pending" | "sent" | "failed" | "skipped" | "unsubscribed";
      ...
      lead_status: "new" | "contacted" | "qualified" | "disqualified" | "nurturing";
      people_doc_status: "valid" | "expiring" | "expired" | "missing";
      people_employment_type: "pj" | "clt" | "contractor" | "intern" | "other";
      people_status: "active" | "bench" | "on_leave" | "offboarding" | "terminated";
      perm_action:
        | "view"
        | "create"
        | "update"
      ...
      quote_status: "draft" | "published" | "sent" | "accepted" | "declined" | "expired";
      ...
      subscription_status: "trialing" | "active" | "paused" | "canceled" | "past_due" | "completed";
...
export const Constants = {
  public: {
    Enums: {
      ...
      people_employment_type: ["pj", "clt", "contractor", "intern", "other"],
      people_status: ["active", "bench", "on_leave", "offboarding", "terminated"],
      perm_action: ["view", "create", "update", "delete", "export", "approve", "assign", "manage"],
      perm_scope: ["own", "team", "workspace", "org"],
      project_member_role: ["manager", "contributor", "viewer"],
      project_milestone_status: ["pending", "in_progress", "done", "cancelled"],
      project_status: ["planning", "active", "on_hold", "done", "cancelled"],
