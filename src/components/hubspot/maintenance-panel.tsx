...
export function HubspotMaintenancePanel() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Verificar registros novos no HubSpot — Atividades</CardTitle>
          <CardDescription>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Varre contatos, empresas, negócios, leads e tickets do HubSpot e importa os que ainda
