      ...
      POST: async ({ request }) => {
        ...
        const result = streamText({
          ...
          tools: {
            ...
            proposeCreateContact: propose(
              "Propor criação de contato (requer aprovação humana)",
              z.object({
                first_name: z.string(),
            ...
            proposeCreateCompany: propose(
              "Propor criação de empresa (requer aprovação)",
              z.object({
                name: z.string(),
            ...
            proposeCreateLead: propose(
              "Propor criação de lead (requer aprovação)",
              z.object({
                first_name: z.string(),
                last_name: z.string().optional(),
                email: z.string().optional(),
            ...
            proposeUpdateContact: propose(
              "Propor atualização de contato existente (requer aprovação)",
              z.object({
                id: z.string(),
            ...
            proposeUpdateLead: propose(
              "Propor atualização de lead existente (requer aprovação)",
              z.object({
                id: z.string(),
                first_name: z.string().optional(),
                last_name: z.string().optional(),
            ...
            proposeCreateDeal: propose(
              "Propor criação de negócio (requer aprovação)",
              z.object({
                name: z.string(),
            ...
            proposeCreateTicket: propose(
              "Propor criação de chamado (requer aprovação)",
              z.object({
                subject: z.string(),
                description: z.string().optional(),
            ...
            proposeCreateActivity: propose(
              "Propor registro de atividade/nota (requer aprovação)",
              z.object({
            ...
            proposeCreateTask: propose(
              "Propor criação de tarefa (requer aprovação)",
              z.object({
                subject: z.string(),
                body: z.string().optional(),
                due_date: z.string().optional(),
            ...
            proposeCreateMeeting: propose(
              "Propor agendamento de reunião (requer aprovação)",
              z.object({
                subject: z.string(),
                body: z.string().optional(),
                starts_at: z.string(),
