    ...
    <div className="min-h-screen bg-background px-4 py-12">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <section className="space-y-3 text-sm leading-relaxed text-foreground">
          ...
          <p>
            Ao acessar e utilizar o WK Technology CRM, você concorda com estes Termos de Serviço e com a
            nossa Política de Privacidade. Se não concordar, não utilize o serviço.
          </p>

          <h2 className="text-lg font-semibold">2. Uso do serviço</h2>
          <p>
            Você se compromete a utilizar a plataforma apenas para finalidades lícitas, respeitando a
            legislação aplicável e os direitos de terceiros. O acesso é concedido por convite emitido por um
          ...
          <p>
            ...
            atividades realizadas em sua conta. Recomendamos ativar a autenticação em dois fatores (2FA).
          </p>

          <h2 className="text-lg font-semibold">4. Conteúdo do usuário</h2>
          <p>
            Você mantém a titularidade dos dados que insere no CRM. Concede-nos apenas a licença necessária
            para armazenar, processar e exibir esses dados com o objetivo de prestar o serviço.
          </p>

          <h2 className="text-lg font-semibold">5. Integrações de terceiros</h2>
          <p>
            Integrações como Google Calendar, Gmail, WhatsApp e Twilio estão sujeitas aos respectivos termos
            dos provedores. Não nos responsabilizamos por indisponibilidade ou alterações nesses serviços.
          </p>

          <h2 className="text-lg font-semibold">6. Limitação de responsabilidade</h2>
          <p>
            O serviço é fornecido "no estado em que se encontra". Na máxima extensão permitida em lei, não
            seremos responsáveis por danos indiretos, lucros cessantes ou perda de dados decorrentes do uso
            ou da impossibilidade de uso da plataforma.
          </p>

          <h2 className="text-lg font-semibold">7. Encerramento</h2>
          <p>
            Podemos suspender ou encerrar o acesso em caso de violação destes termos. Você pode encerrar sua
            conta a qualquer momento solicitando ao administrador do workspace.
          </p>

          <h2 className="text-lg font-semibold">8. Alterações</h2>
          <p>
            Estes termos podem ser atualizados periodicamente. Mudanças relevantes serão comunicadas por
        ...
        <div className="pt-4 border-t">
          <Link to="/privacy" className="text-sm text-primary hover:underline">Ver Política de Privacidade →</Link>
        </div>
      </div>
    </div>
  );
