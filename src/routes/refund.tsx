    ...
    <div className="min-h-screen bg-background px-4 py-12">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <section className="space-y-3 text-sm leading-relaxed text-foreground">
          ...
          <p>
            Em conformidade com o art. 49 do Código de Defesa do Consumidor, o cliente tem direito
            ao arrependimento no prazo de <strong>7 (sete) dias corridos</strong> após a contratação
            realizada fora do estabelecimento (incluindo contratações online), com reembolso
          ...
          <p>
            ...
            . O acesso permanece ativo até o fim do ciclo já pago. Não há reembolso proporcional
            para ciclos já iniciados, salvo na hipótese do item 1.
          </p>
          ...
          <p>
            ...
            valor remanescente. Crédito restituído em até 30 dias por meio do mesmo método de
            pagamento.
          </p>

          <h2 className="text-lg font-semibold">4. Falha do serviço</h2>
          <p>
            Em caso de indisponibilidade não programada superior a 24 horas em um mesmo mês, o
            cliente poderá solicitar bonificação proporcional, mediante abertura de chamado em{" "}
          ...
          <p>
            ...
            não ser reembolsáveis. O reembolso é feito sobre o valor líquido recebido pela WK
            Technology.
          </p>
          ...
          <p>
            ...
            <a
              href="mailto:financeiro@wktechnology.com.br"
