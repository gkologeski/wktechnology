  ...
  head: () => ({
    meta: [
      { title: "DPA — Acordo de Processamento de Dados — WK Technology CRM" },
      {
        name: "description",
        content:
          "Data Processing Agreement (DPA) do WK Technology CRM para clientes B2B, alinhado à LGPD e ao GDPR.",
      },
      {
        property: "og:title",
        content: "DPA — Acordo de Processamento de Dados — WK Technology CRM",
      },
      {
      ...
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <section className="space-y-3 text-sm leading-relaxed text-foreground">
          ...
          <p>
            ...
            <strong> WK Technology</strong>, na qualidade de <strong>Operador</strong>, e
            complementa os Termos de Serviço. Em caso de conflito sobre tratamento de dados
            pessoais, prevalece este DPA.
          </p>
          ...
          <p>
            ...
            dados de identificação, contato, profissionais, históricos comerciais e mensagens. Não
            tratamos dados sensíveis intencionalmente; cabe ao Cliente evitar inseri-los.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              Implementar medidas técnicas e organizacionais (RLS, criptografia em trânsito e
              repouso, controle de acesso, logs de auditoria, backups diários).
            </li>
            <li>
              Comunicar incidentes de segurança em até <strong>48 horas</strong> da ciência.
            </li>
          ...
          <p>
            ...
            Stripe e gateways BR (pagamentos), Google e Microsoft (calendário/e-mail quando
            habilitados). Alterações relevantes serão comunicadas com 30 dias de antecedência.
          </p>
          ...
          <p>
            ...
            adequadas (cláusulas-padrão contratuais, certificações SOC 2/ISO 27001 dos
            suboperadores).
          </p>
