    ...
    <div className="min-h-screen bg-background px-4 py-12">
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <section className="space-y-3 text-sm leading-relaxed text-foreground">
          ...
          <p>
            Coletamos informações que você nos fornece diretamente ao criar sua conta, como nome,
            e-mail e dados relacionados aos seus contatos, leads, empresas, negócios e atividades
            registradas no CRM.
          </p>

          <h2 className="text-lg font-semibold">2. Uso das informações</h2>
          <p>
            Utilizamos os dados para fornecer e melhorar nossos serviços, autenticar usuários,
            sincronizar integrações autorizadas (como Google Calendar e Gmail) e oferecer suporte.
          </p>

          <h2 className="text-lg font-semibold">3. Compartilhamento</h2>
          <p>
            Não vendemos seus dados. Compartilhamos informações apenas com provedores essenciais
            para a operação do serviço (hospedagem, autenticação, e-mail) e quando exigido por lei.
          </p>

          <h2 className="text-lg font-semibold">4. Integrações com Google</h2>
          <p>
            Quando você conecta sua conta Google, acessamos apenas os escopos autorizados (Calendar,
            Gmail) para executar as funcionalidades solicitadas. Você pode revogar o acesso a
            qualquer momento em sua conta Google ou nas configurações do CRM.
          </p>
          ...
          <p>
            ...
            criptografia em trânsito, controle de acesso por workspace e políticas de segurança em
            nível de linha (RLS).
          </p>
