...
export const Route = createFileRoute("/_authenticated/settings/legal-entity-groups")({
...
function LegalEntityGroupsPage() {
                ...
                <div className="space-y-1">
                  {entities.length === 0 && (
                    <div className="text-sm text-muted-foreground p-2">
                      Nenhum CNPJ cadastrado. Cadastre em Configurações → Empresas (CNPJs).
                    </div>
                  )}
                  {entities.map((e) => {
