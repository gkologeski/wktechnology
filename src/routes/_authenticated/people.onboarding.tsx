...
export const Route = createFileRoute("/_authenticated/people/onboarding")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Progresso e tarefas de integração de novas pessoas." },
    ],
  }),
              ...
              <TableRow>
                <TableCell colSpan={6} className="text-center py-12">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <div className="text-xs text-muted-foreground">Inicie um plano na ficha da pessoa (aba Onboarding).</div>
                  </div>
                </TableCell>
              </TableRow>
            ) : (
