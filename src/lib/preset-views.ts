  ...
  leads: [
    { id: "preset:all", name: "Todos", filters: { type: "group", op: "and", conditions: [] } },
    {
      ...
      filters: {
        type: "group",
        op: "and",
        conditions: [{ type: "condition", field: "status", op: "neq", value: "disqualified" }],
      },
    },
    { id: "preset:my", name: "Meus leads", filters: { type: "group", op: "and", conditions: [] } },
    {
      id: "preset:hot",
      name: "Quentes (score > 50)",
      filters: {
        type: "group",
        op: "and",
        conditions: [{ type: "condition", field: "score", op: "gt", value: 50 }],
      },
    },
  ],
  deals: [
    ...
    },
    {
      ...
      filters: {
        type: "group",
        op: "and",
        conditions: [{ type: "condition", field: "stage", op: "eq", value: "won" }],
      },
    },
    {
      id: "preset:lost",
      ...
      filters: {
        type: "group",
        op: "and",
        conditions: [{ type: "condition", field: "stage", op: "eq", value: "lost" }],
      },
    },
  ],
  contacts: [
  ...
  companies: [
    { id: "preset:all", name: "Todas", filters: { type: "group", op: "and", conditions: [] } },
    {
      ...
      filters: {
        type: "group",
        op: "and",
        conditions: [{ type: "condition", field: "is_target_account", op: "eq", value: true }],
      },
    },
  ],
};
