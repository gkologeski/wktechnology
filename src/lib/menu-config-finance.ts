...
import { MENU_PERMISSIONS, adminAny, type SidebarGroup } from "@/lib/menu-config";
...
export const FINANCE_SIDEBAR_GROUPS: SidebarGroup[] = [
  {
    ...
    items: [
      ...
      { title: "Empresas (CNPJs)", url: "/finance/legal-entities", icon: Building2, need: "admin", permissionAny: adminAny("techfinance.legal_entities") },
      { title: "Grupos empresariais", url: "/finance/legal-entity-groups", icon: Building2, need: "admin", permissionAny: adminAny("techfinance.legal_entity_groups") },
