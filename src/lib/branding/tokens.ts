...
export const BRAND_TOKENS: BrandToken[] = [
  ...
  {
    key: "product-canvas",
    label: "Canvas operacional",
    group: "surfaces",
    light: "#e9f1f8",
    dark: "#050b11",
    hint: "Fundo cinza-azulado de listas e detalhes.",
  },
  {
    key: "product-header",
    label: "Cabeçalho operacional",
    group: "surfaces",
    light: "#f7fbfe",
    dark: "#0f1822",
  },
  ...
  {
    key: "product-divider",
    label: "Divisória operacional",
    group: "surfaces",
    light: "#c9d4dd",
    dark: "#353e47",
    hint: "Bordas entre faixas, colunas e painéis.",
  },
