...
describe("cleanEmailSignatureHtml", () => {
  const signature = 'Abraços,<br><table><tbody><tr><td><img src="https://example.com/photo.png"></td><td><a href="https://example.com">Guilherme</a></td></tr></tbody></table>';
  ...
  it("leaves ordinary signatures and intentionally sized content unchanged", () => {
    ...
    expect(cleanEmailSignatureHtml('<div style="height: 100px">Logo</div>')).toBe('<div style="height: 100px">Logo</div>');
